...
`no_std` Rust library providing efficient and safe utilities for reading and writing data structures in both little-endian and big-endian formats.

# Project Structure

- `endian-writer/` - Main library crate
  - `src/` - Library source code (traits, readers, writers, alignment utilities)
